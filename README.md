...
<div align="center">
  ...
  <p>
    <a href="https://github.com/Qinyong-Wang/scale_up_game/releases/latest"><img alt="Latest release" src="https://img.shields.io/badge/release-v0.1.1--alpha.4-202124"></a>
  ...
  <p>
    <a href="https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4-windows-x86_64.zip"><img alt="点击下载 Windows 版" src="https://img.shields.io/badge/点击下载-Windows%20版-202124?style=for-the-badge"></a>
    <a href="https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4.zip"><img alt="点击下载 macOS 版" src="https://img.shields.io/badge/点击下载-macOS%20版-666666?style=for-the-badge"></a>
  </p>
  <p>
...
| Windows x86_64 | [点击下载 Windows 版](https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4-windows-x86_64.zip) | 解压后运行桌面版。 |
| macOS | [点击下载 macOS 版](https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4.zip) | 解压后运行桌面版。 |
...
| Windows x86_64 | [点击下载 Windows 版](https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4-windows-x86_64.zip) | 解压后保持 `Scaling-Up.exe` 与 `Scaling-Up.pck` 在同一目录，再运行 `Scaling-Up.exe`。 |
| macOS | [点击下载 macOS 版](https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4.zip) | 解压后运行 `Scaling-Up.app`。ad-hoc 签名版本首次打开时可能需要右键选择“打开”。 |

macOS 包已做 ad-hoc 签名，但尚未 Apple 公证。若 macOS 提示无法验证开发者，请右键选择“打开”；若你下载过旧包并看到“已损坏”，请删除旧 zip / app 后重新下载最新版。

| 当前试玩包 | 游戏版本 | 引擎 | 语言 | 许可证 |
|---|---|---|---|---|
| `v0.1.1-alpha.4` | `0.1.1-alpha.4` | Godot `4.4.1 stable` | 英文默认，中文 / English 可切换 | `GPL-3.0-only` |
...
<div align="center">
  ...
  <p>
    <a href="https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4-windows-x86_64.zip"><img alt="Download for Windows" src="https://img.shields.io/badge/Download-Windows-202124?style=for-the-badge"></a>
    <a href="https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4.zip"><img alt="Download for macOS" src="https://img.shields.io/badge/Download-macOS-666666?style=for-the-badge"></a>
  </p>
  <p>
...
|---|---|---|---|---|---|
| `v0.1.1-alpha.4` | `0.1.1-alpha.4` | Godot `4.4.1 stable` | English default, Chinese / English switchable | Web, macOS, Windows x86_64 | `GPL-3.0-only` |
...
| Windows x86_64 | [Download for Windows](https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4-windows-x86_64.zip) | Unzip and keep `Scaling-Up.exe` and `Scaling-Up.pck` in the same folder before running the game. |
| macOS | [Download for macOS](https://github.com/Qinyong-Wang/scale_up_game/releases/download/v0.1.1-alpha.4/Scaling-Up-0.1.1-alpha.4.zip) | Unzip and run `Scaling-Up.app`. The ad-hoc signed build may require right-clicking and choosing "Open" on first launch. |
